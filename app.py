...
# ==========================================
    ...
    # --- RESTORED: UNIT STATUS METRICS (INDUSTRIAL) ---
    ...
    with tabs_i[0]: # Machine Tracker
        ...
        sel_c_i = col1_i.selectbox("Select Customer (IND)", ["All"] + c_list_i, key="ind_c")
...
# --- Logic for Tabs 2 & 3 (FOC List & Pending) restored correctly below ---
