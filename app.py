...
if page_choice == "1. DPSAC Tracker":
    ...
    with tabs[0]:
        ...
        sel_c = c1_top.selectbox("Select Customer Name", ["All"] + c_list, key="dpsac_c_filter")
        df_f = master_df if sel_c == "All" else master_df[master_df['CUSTOMER NAME'] == sel_c]
        sel_f = c2_top.selectbox("Select Fabrication No", ["Select"] + sorted(df_f['Fabrication No'].astype(str).unique()), key="dpsac_f_filter")
